...
public class SevenSegment extends JPanel implements ActionListener
{
  ...
  public void paintComponent(Graphics g)
  {
  	...
  	segments[0] = number[1] || number[3] || (number[0] && number[2]) || (!number[2] && !number[0]);

  	segments[1] = (!number[2] && !number[3]) || number[0] || (number[2] && number[3]) || (!number[1] && number[2]) || (!number[1] && number[3]);
